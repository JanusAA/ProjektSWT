...
public class BreweryDTO extends Ownable {
	...
	/**
	 *  Hvis man lander på et bryggeri som er ejet,
	 * skal man betale en variabel leje til ejeren.
	 * Lejen er bestemt efter hvor mange af denne type ejendom man ejer
	 * dvs. at når der kræves leje, er det på baggrund af antallt af ejet
	 * bryggerier og hvilket slag der er slået for at lande på bruggeriet.
	 * Beløbet udregnes således og metoden returnerer det betalte beløb,
	 * som bruges til at tælle balancen ned i GUIen
	 */
	@Override
	...
	/**
	 * Superklassens metode til at kÃ¸be feltet genbruges
	 * derudover registreres det at denne spiller har kÃ¸bt 
